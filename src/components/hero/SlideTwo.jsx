  ...
  return (
    <div className="grid min-h-[calc(100svh-5rem)] items-center gap-8 px-5 py-20 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-14">
      ...
      >
        ...
        <h2 className="font-display mt-4 text-4xl leading-tight text-white sm:text-5xl lg:text-[3.35rem]">
        ...
        <div className="mt-6 space-y-3">
          {points.map((point) => (
            <div
              key={point}
              className="flex items-center gap-3 rounded-2xl border border-[rgba(201,166,70,0.22)] bg-white/10 px-4 py-3 text-white/88 backdrop-blur-sm"
            >
